  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container" align="left">
			<h2 align="center"><font size=7>Baja Usuario</font></h2> 
      </div>
	</div>

    <div class="container">
      <!-- Example row of columns -->
				<h2 Style="color:#0000FF">Dar de baja del sitio a un usuario.</h2>
				<h3>Ingrese al menos un dato del usuario: </h3><br>
				<form method="POST" action="bajaForm.php">
		...
		<?php if(!empty($_POST))  { 
						...
						if($aux==1){ 
							if(!empty($user)){ ?>
								...
								<a class="btn btn-lg btn-primary btn-block" href="bajaUsuario.php?username=<?php echo $user['nombre_usuario']; ?>" role="button">Confirmar Baja &raquo;</a>
								<a class="btn btn-lg btn-primary btn-block" href="bajaForm.php" role="button">Cancelar &raquo;</a> <?php			
							}else{ ?>
