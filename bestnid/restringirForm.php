  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container" align="left">
			<h2 align="center"><font size=7>Restringir Acceso</font></h2> 
      </div>
	</div>

    <div class="container">
      <!-- Example row of columns -->
				<h2 Style="color:#0000FF">Restringir el acceso a un usuario.</h2>
				<h3>Ingrese al menos un dato del usuario: </h3><br>
				<form method="POST" action="restringirForm.php">
					...
					<a class="btn btn-lg btn-primary btn-block" href="index.php" role="button">Volver &raquo;</a>
				</form> 
		</div>
    <hr>
		...
		<?php if(!empty($_POST))  { 
						...
						if($aux==1){ 
							if(!empty($user)){ ?>
								...
								<?php if($user['admin']==2){ ?>
									<font size=4><p align=center><b Style="color:#D00909">Este usuario se encuentra bloqueado</b></p></font>
									<a class="btn btn-lg btn-primary btn-block" href="desbloquear.php?username=<?php echo $user['nombre_usuario']; ?>" role="button">Desbloquear usuario &raquo;</a>
									<a class="btn btn-lg btn-primary btn-block" href="restringirForm.php" role="button">Cancelar &raquo;</a> <?php
								}else{ ?>
									<a class="btn btn-lg btn-primary btn-block" href="restringir.php?username=<?php echo $user['nombre_usuario']; ?>" role="button">Confirmar bloqueo &raquo;</a>
									<a class="btn btn-lg btn-primary btn-block" href="restringirForm.php" role="button">Cancelar &raquo;</a> <?php			
								}		
							}else{ ?>
